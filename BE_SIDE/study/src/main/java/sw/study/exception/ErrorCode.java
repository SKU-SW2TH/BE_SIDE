...
public enum ErrorCode {
    ...
    // S3 파일 업로드 관련
    FILE_UPLOAD_ERROR(HttpStatus.BAD_REQUEST,"FILE_UPLOAD_ERROR", "파일 업로드에 실패하였습니다."),
    S3_UPLOAD_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,"S3_UPLOAD_ERROR", " S3 업로드에 실패하였습니다.");
